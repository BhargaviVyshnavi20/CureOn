...
const PatientHistoryModal = ({ open, onOpenChange, patient }: PatientHistoryModalProps) => {
  ...
  const consultations = [
    { id: 1, date: "Jan 20, 2026", type: "Video Call", doctor: "Dr. Sarah Johnson", notes: "Follow-up for respiratory infection. Patient showing improvement.", status: "Completed" },
    { id: 2, date: "Jan 15, 2026", type: "In-Person", doctor: "Dr. Sarah Johnson", notes: "Initial consultation for persistent cough and fever.", status: "Completed" },
    { id: 3, date: "Dec 28, 2025", type: "Video Call", doctor: "Dr. Michael Chen", notes: "Routine checkup. Blood pressure normal.", status: "Completed" },
  ];
      ...
      <DialogContent className="sm:max-w-3xl max-h-[85vh] overflow-hidden flex flex-col">
        ...
        <Tabs defaultValue="prescriptions" className="flex-1 overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto mt-4">
            ...
            <TabsContent value="consultations" className="mt-0 space-y-3">
              {consultations.map((consult) => (
                <div key={consult.id} className="p-4 rounded-xl bg-secondary/50 border border-border">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <h4 className="font-semibold text-foreground">{consult.doctor}</h4>
                    ...
                    <span className="badge-status badge-success">{consult.status}</span>
                  </div>
